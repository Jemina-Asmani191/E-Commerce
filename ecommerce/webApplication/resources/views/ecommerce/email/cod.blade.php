...
<body>
    <div style="border-top-left-radius: 3px; border-top-right-radius: 3px; padding: 10px 15px; background-color: #428bca; border-color: #428bca; color: #fff" class="v1panel-heading">
        You Have Mail Recieved from Ecommerce Website
         </div>
    ...
    <table width="100%" cellpadding="5" cellspacing="5" border="1px">
            ...
            <tr>
                ...
                <?php $total_price = 0; $total_price = ($product['product_qty'])*($product['product_price']);?>
           ...
           @endforeach
            ...
            <tr>
                <td colspan="6" align="right"><strong>Coupon Discount (-) </strong></td>  <td>Rs. {{$productDetails['coupon_amount']}}</td>
            </tr>
            <tr>
                <td colspan="6" align="right"><strong>Grand Total</td>  </strong><td>Rs. {{$productDetails['grand_total']}}</td>
            </tr>
    </table>
    <h4>Yours Billing & Shipping Address are as follows</h4> <br>
       ...
       <div class="billto" style="width:50%;float:left">
        <b>Billing Address</b> <br><br>
           ...
           <strong>Address : </strong>{{$userDetails['name']}} <br>
   ...
   <div>
   <br><br><br><br>
    <p>Note : If you need any query regarding this email plz feel free to contact us <a href="mailto:thewayshop1918@gmail.com">thewayshop1918@gmail.com</a></p>
    <br>
    <b>Regards</b> <br>
    Wayshop Team
   </div>
