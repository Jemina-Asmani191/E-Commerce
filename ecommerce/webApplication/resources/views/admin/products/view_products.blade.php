                            ...
                            <table id="table_id" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('/admin/add_attributes/'.$product->id)}}" class="btn btn-warning btn-sm" title="Edit Attributes"><i class="fa fa-list"></i></a>
                                            <a href="{{url('/admin/edit_product/'.$product->id)}}" class="btn btn-add btn-sm" title="Edit Products"><i class="fa fa-pencil"></i></a>
                                            <a href="{{url('/admin/delete_product/'.$product->id)}}" class="btn btn-danger btn-sm" title="Delete"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
