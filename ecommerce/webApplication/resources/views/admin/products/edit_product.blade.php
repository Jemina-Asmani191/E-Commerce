            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/edit_product/'.$productDetails->id)}}" method="post"> {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <img style="width:100px;height:100px;margin-top:10px" src="{{asset('/uploads/products/'.$productDetails->image)}}">
                                @endif
                            </div>
