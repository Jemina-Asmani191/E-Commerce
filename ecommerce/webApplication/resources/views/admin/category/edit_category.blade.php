            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <form class="col-sm-6" action="{{url('/admin/edit_category/'.$categoryDetails->id)}}" method="post"> {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="category_description" id="category_description" class="form-control" rows="10">
