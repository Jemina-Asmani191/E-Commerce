                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="table_id" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach($userDetail as $customer)
                                    <tr>
                                        <td>{{$customer->id}}</td>
                                        <td>{{$customer->name}}</td>
                                        <td>{{$customer->email}}</td>
                                        <td>
                                            <input type="checkbox" class="CustomerStatus btn btn-success" rel="{{$customer->id}}" data-toggle="toggle" data-on="Active" data-of="Inactive" data-onstyle="success" data-offstyle="danger" @if($customer['status'] == "1" ) checked @endif>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('/admin/delete_customer/'.$customer->id)}}" class="btn btn-danger btn-sm" title="Delete" onclick="return confirm('Are you sure!');"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                              ...
                              <div class="modal-body">
                                <table id="table_id" class="table table-bordered table-striped table-hover">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="taskDesc">Mobile Number</td>    
